...
_IndigoRPEOptionsHandlersSetter::_IndigoRPEOptionsHandlersSetter ()
{
   ...
   mgr.setOptionHandlerBool("rpe-multistep-reactions", SET_BOOL_OPTION(indigo.rpe_params.is_multistep_reactions));
   mgr.setOptionHandlerString("rpe-mode", indigoProductEnumeratorSetOneTubeMode, indigoProductEnumeratorGetOneTubeMode);
   mgr.setOptionHandlerBool("rpe-self-reaction", SET_BOOL_OPTION(indigo.rpe_params.is_self_react));
   mgr.setOptionHandlerInt("rpe-max-depth", SET_INT_OPTION(indigo.rpe_params.max_deep_level));
   mgr.setOptionHandlerInt("rpe-max-products-count", SET_INT_OPTION(indigo.rpe_params.max_product_count));
   mgr.setOptionHandlerBool("rpe-layout", SET_BOOL_OPTION(indigo.rpe_params.is_layout));
   mgr.setOptionHandlerBool("transform-layout", SET_BOOL_OPTION(indigo.rpe_params.transform_is_layout));
}
