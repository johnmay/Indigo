...
#define CHECK_AND_SET_COLOR_OPTION(option)                         \
...
_IndigoRenderingOptionsHandlersSetter::_IndigoRenderingOptionsHandlersSetter ()
{
   ...
   mgr.setOptionHandlerInt("render-comment-offset", SET_INT_OPTION(rp.cnvOpt.commentOffset));
   mgr.setOptionHandlerInt("render-image-width", SET_INT_OPTION(rp.cnvOpt.width));
   mgr.setOptionHandlerInt("render-image-height", SET_INT_OPTION(rp.cnvOpt.height));
   mgr.setOptionHandlerInt("render-image-max-width", SET_INT_OPTION(rp.cnvOpt.maxWidth));
   mgr.setOptionHandlerInt("render-image-max-height", SET_INT_OPTION(rp.cnvOpt.maxHeight));
   ...
   mgr.setOptionHandlerString("render-comment", SET_STR_OPTION(rp.cnvOpt.comment));
   ...
   mgr.setOptionHandlerString("render-atom-color-property", SET_STR_OPTION(rp.rOpt.atomColorProp));

   mgr.setOptionHandlerBool("render-coloring", SET_BOOL_OPTION(rp.rOpt.atomColoring));
   mgr.setOptionHandlerBool("render-valences-visible", SET_BOOL_OPTION(rp.rOpt.showValences));
   mgr.setOptionHandlerBool("render-atom-ids-visible", SET_BOOL_OPTION(rp.rOpt.showAtomIds));
   mgr.setOptionHandlerBool("render-bond-ids-visible", SET_BOOL_OPTION(rp.rOpt.showBondIds));
   mgr.setOptionHandlerBool("render-atom-bond-ids-from-one", SET_BOOL_OPTION(rp.rOpt.atomBondIdsFromOne));
   mgr.setOptionHandlerBool("render-highlight-thickness-enabled", SET_BOOL_OPTION(rp.rOpt.highlightThicknessEnable));
   mgr.setOptionHandlerBool("render-highlight-color-enabled", SET_BOOL_OPTION(rp.rOpt.highlightColorEnable));
   mgr.setOptionHandlerBool("render-center-double-bond-when-stereo-adjacent", SET_BOOL_OPTION(rp.rOpt.centerDoubleBondWhenStereoAdjacent));
   mgr.setOptionHandlerBool("render-implicit-hydrogens-visible", SET_BOOL_OPTION(rp.rOpt.implHVisible));
   mgr.setOptionHandlerBool("render-highlighted-labels-visible", SET_BOOL_OPTION(rp.rOpt.highlightedLabelsVisible));
   mgr.setOptionHandlerBool("render-bold-bond-detection", SET_BOOL_OPTION(rp.rOpt.boldBondDetection));

   mgr.setOptionHandlerFloat("render-bond-length", SET_FLOAT_OPTION(rp.cnvOpt.bondLength));
   ...
   mgr.setOptionHandlerFloat("render-comment-font-size", SET_FLOAT_OPTION(rp.rOpt.commentFontFactor));
   mgr.setOptionHandlerString("render-comment-alignment", indigoRenderSetCommentAlignment, indigoRenderGetCommentAlignment);
   mgr.setOptionHandlerFloat("render-comment-spacing", SET_FLOAT_OPTION(rp.rOpt.commentSpacing));

   mgr.setOptionHandlerColor("render-background-color", SET_COLOR_OPTION(rp.rOpt.backgroundColor));
   mgr.setOptionHandlerColor("render-base-color", SET_COLOR_OPTION(rp.rOpt.baseColor));
   mgr.setOptionHandlerColor("render-highlight-color", CHECK_AND_SET_COLOR_OPTION(rp.rOpt.highlightColor));
   mgr.setOptionHandlerColor("render-aam-color", CHECK_AND_SET_COLOR_OPTION(rp.rOpt.aamColor));
   mgr.setOptionHandlerColor("render-comment-color", CHECK_AND_SET_COLOR_OPTION(rp.rOpt.commentColor));
   mgr.setOptionHandlerColor("render-data-sgroup-color", CHECK_AND_SET_COLOR_OPTION(rp.rOpt.dataGroupColor));

   mgr.setOptionHandlerXY("render-image-size", SET_XY_OPTION(rp.cnvOpt.width, rp.cnvOpt.height));
   mgr.setOptionHandlerXY("render-hdc-offset", SET_XY_OPTION(rp.cnvOpt.xOffset, rp.cnvOpt.yOffset));
   mgr.setOptionHandlerXY("render-margins", SET_XY_OPTION(rp.cnvOpt.marginX, rp.cnvOpt.marginY));

   mgr.setOptionHandlerXY("render-grid-margins", SET_XY_OPTION(rp.cnvOpt.gridMarginX, rp.cnvOpt.gridMarginY));
   mgr.setOptionHandlerFloat("render-grid-title-spacing", SET_FLOAT_OPTION(rp.rOpt.titleSpacing));
   mgr.setOptionHandlerString("render-grid-title-alignment", indigoRenderSetTitleAlignment, indigoRenderGetTitleAlignment);
   mgr.setOptionHandlerFloat("render-grid-title-font-size", SET_FLOAT_OPTION(rp.rOpt.titleFontFactor));
   mgr.setOptionHandlerString("render-grid-title-property", SET_STR_OPTION(rp.cnvOpt.titleProp));
   mgr.setOptionHandlerInt("render-grid-title-offset", SET_INT_OPTION(rp.cnvOpt.titleOffset));

   mgr.setOptionHandlerBool("render-cdxml-properties-enabled", SET_BOOL_OPTION(cdxmlContext.enabled));
   mgr.setOptionHandlerString("render-cdxml-properties-fonttable", SET_STR_OPTION(cdxmlContext.fonttable));
   mgr.setOptionHandlerString("render-cdxml-properties-colortable", SET_STR_OPTION(cdxmlContext.colortable));
   mgr.setOptionHandlerString("render-cdxml-properties-name-property", SET_STR_OPTION(cdxmlContext.propertyNameCaption));
   mgr.setOptionHandlerString("render-cdxml-properties-value-property", SET_STR_OPTION(cdxmlContext.propertyValueCaption));
   ...
   mgr.setOptionHandlerFloat("render-cdxml-properties-size", SET_FLOAT_OPTION(cdxmlContext.propertyFontSize));
   mgr.setOptionHandlerString("render-cdxml-title-font", SET_STR_OPTION(cdxmlContext.titleFont));
   mgr.setOptionHandlerString("render-cdxml-title-face", SET_STR_OPTION(cdxmlContext.titleFace));
